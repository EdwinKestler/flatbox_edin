...
(library Library_1
	...
	(compDef "MAX6817EUT+T" (originalName "MAX6817EUT+T") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		...
		(compPin "4" (pinName "OUT2") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "http://datasheets.maximintegrated.com/en/ds/MAX6816-MAX6818.pdf")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "MAX6817EUT+T.stp")
